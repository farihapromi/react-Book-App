...
<Link className="btn bg-green-500 text-white rounded-lg" to='/sign-up'>Sign Up</Link>
<Link  className="btn bg-cyan-500 text-white rounded-lg" to='/sign-in'>Sign In</Link>
  </div>
</div>
  )
}
